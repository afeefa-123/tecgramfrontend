...
export function CreateWard() {
  ...
  const handleOnSubmit = async () => {
    ...
    if(wardNo>0 && member){
      try {
        await axios.post(`${SERVER_ADDRESS}/user/createWard`, { ward: {
          ...wardDetails,
        ...
        <div className="createWard_rootDiv">
          <div className='topFlexiv'>
            <div style={{ overflowY: 'auto', padding: '20px' }}>
              <h1 className="hero_title">CREATE WARD</h1>
              <form>
                <div className="gridDiv">
                  <div className='gridItem'>
                    ...
                    <PitInputLabelled height='35px' type='number' onChange={handleOnchange} inputTitle='Ward No' width='100%' name='wardNo' placeholder="Ward No" />
